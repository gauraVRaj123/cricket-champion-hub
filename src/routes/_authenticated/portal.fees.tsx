...
function MyFees() {
  ...
  const paidThisMonth = payments.some(
    (p) => p.fee_month.slice(0, 7) === currentMonth,
  );
        ...
        <>
          <div className="grid sm:grid-cols-3 gap-3 mb-6">
            <div className="border border-border p-4">
              ...
              <div className="font-display text-3xl">₹{monthlyFee}</div>
            </div>
            <div className="border border-border p-4">
              <div className="text-xs font-mono uppercase text-primary">
                This Month
                ...
                >
                  ...
                  <div className="flex items-center gap-4 shrink-0">
                    ...
                    <button
                      ...
                      className="text-xs font-mono uppercase tracking-widest border border-border px-3 py-1.5 hover:bg-foreground hover:text-background"
                    >
                      Receipt
                    </button>
                  </div>
