        ...
        >
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <PSelect
              label="Playing role"
              name="playing_role"
              defaultValue={profile?.playing_role ?? ""}
          ...
          <PField
            ...
            name="parent_name"
            defaultValue={profile?.parent_name ?? ""}
            required
          />
          <PTextArea
            label="Address"
          ...
          <PSelect
            ...
            defaultValue={profile?.preferred_batch ?? ""}
            options={batches.map((b) => ({
              value: b.batch_name,
              label: `${b.batch_name} (${b.age_group})`,
            }))}
          />
          ...
          />
          <PTextArea
            label="Medical info / allergies"
            name="medical_info"
            defaultValue={profile?.medical_info ?? ""}
          />
          <button
            disabled={saving}
            className="bg-primary text-primary-foreground px-6 py-3 font-bold uppercase tracking-widest text-sm hover:bg-foreground transition-colors disabled:opacity-50 w-full"
          >
            ...
            {docs.map((d) => (
              ...
              >
                ...
                <div className="flex gap-2 shrink-0">
                  ...
                  <button
                    onClick={() => deleteDoc(d.id, d.file_path)}
  ...
  return (
    <div>
      ...
      <input
        ...
        required={required}
        maxLength={255}
        className="w-full bg-background border border-border px-4 py-2 text-sm focus:outline-none focus:border-primary"
      />
    </div>
  );
}
