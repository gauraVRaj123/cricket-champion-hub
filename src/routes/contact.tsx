...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Visit our ground, call, WhatsApp or email Stump & Stride Cricket Academy, Mumbai." },
    ],
  }),
...
function ContactPage() {
  return (
    <>
      <PageHero
        eyebrow="[ 07 ] Contact"
        title={<>Come <span className="text-primary">visit.</span></>}
          ...
          <div className="space-y-8">
            {[
              ...
              <div key={h} className="border-b border-border pb-6">
                ...
                <div className="font-display text-2xl whitespace-pre-line">{v}</div>
              </div>
            ))}
          </div>
